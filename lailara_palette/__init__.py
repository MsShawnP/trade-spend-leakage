...
LL_SEQ_CHICAGO = [
    "#0a0f29", "#141e52", "#1f2e7a", "#3348a8",
    "#475ed1", "#6474c0", "#8e9ad0", "#c5cbe6",
]

LL_SEQ_TOKYO = [
    "#470f1c", "#6e1a2c", "#7e1f34", "#94243c",
    "#b82d4a", "#cc3a59", "#e68a9a", "#f3c1cb",
]

LL_SEQ_SINGAPORE = [
    "#4a2508", "#7a3d10", "#a05a1a", "#c87222",
    "#ee8a2a", "#f4a85c", "#f6b97c", "#fbdabc",
]

LL_SEQ_RED = [
    "#4d0604", "#7a0906", "#8e0b07", "#a80d08",
    "#cc100a", "#db2418", "#e8625d", "#f4b3b1",
]
